...
When prompted about storage usage, please input Y and hit enter. The command will pull the corresponding Elasticsearch and Kibana distribution.

### Setup Elasticsearch

In this exercise, we will set up Elasticsearch, our data store.  The Elasticsearch configuration file is located in `/home/ubuntu/elastic/elasticsearch-7.5.2`.  As you can see we are using the latest Elasticsearch, version 7.5.2
