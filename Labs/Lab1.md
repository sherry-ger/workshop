...
1. Start a new terminal
2. Go to the filebeat directory, `cd elastic/filebeat-7.5.2-linux-x86_64/`
...
```
  # Server log:  server:
    ...
    var.paths:
     - /home/ubuntu/elastic/elasticsearch-7.5.2/logs/*.log
     - /home/ubuntu/elastic/elasticsearch-7.5.2/logs/*_server.json
```
